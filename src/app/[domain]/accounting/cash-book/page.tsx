    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between flex-wrap gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link href={`/accounting/cash-book/print?fy=${fyId}`} target="_blank">
        ...
        <table className="w-full text-sm">
          <thead className="bg-slate-50/60 text-[10px] uppercase tracking-widest text-slate-500 font-black">
            <tr>
              ...
              <th className="px-4 py-3 text-right w-28">Receipt (Dr)</th>
              <th className="px-4 py-3 text-right w-28">Payment (Cr)</th>
          ...
          <tbody className="divide-y divide-slate-100/60">
            ...
            {book.rows.length === 0 && (
              <tr><td colSpan={6} className="p-10 text-center text-sm text-muted-foreground">No cash activity in this period.</td></tr>
            )}
          </tbody>
