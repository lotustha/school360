...
export default async function LearnThreadPage({
  params,
}: {
  ...
  if (!session?.user?.schoolId) redirect(`/${domain}/login?next=/lms/learn/${id}/discussions/${tid}`)
  ...
  return <ThreadView data={data} listHref={`/lms/learn/${id}/discussions`} />
}
